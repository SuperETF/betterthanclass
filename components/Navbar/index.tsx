      ...
      <nav className="fixed top-0 w-full z-50 bg-white shadow-sm">
        <div className="max-w-7xl mx-auto px-2 sm:px-4">
          <div className="flex items-center justify-between h-14 relative">
            ...
            {/* 로고(가운데) */}
            <Link href="/" className="flex-1 flex justify-center md:justify-start items-center" passHref>
              <span className="text-xl font-bold bg-gradient-to-r from-pink-500 via-purple-500 to-blue-500 bg-clip-text text-transparent cursor-pointer">
                유리한 클래스
              </span>
            </Link>
            {/* 우측: 로그인/회원가입 */}
